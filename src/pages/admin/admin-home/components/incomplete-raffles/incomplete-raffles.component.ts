...
@Component({
  ...
  templateUrl: './incomplete-raffles.component.html',
  styleUrls: ['./incomplete-raffles.component.scss']
})
export class IncompleteRafflesComponent extends Extender implements OnInit {
