...
export class FormFieldComponent implements AfterContentInit {
  ...
  public get gethasValueState(): boolean {
    return this.input && this.input.element.value.trim() !== '' ? true : false;
  }
  ...
  public get getInvalidState(): boolean {
    ...
    state && this.input.control.touched ? this.input.element.classList.add('is-invalid') : this.input.element.classList.remove('is-invalid');
    return state;
  }
